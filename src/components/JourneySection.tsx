  ...
  const milestones = [
    {
      ...
      description: "Surveyed existing research on multi-agent systems, privacy-preserving ML, and data pipeline architectures.",
      status: "completed",
    },
    {
      icon: Lightbulb,
      date: "Winter 2024",
      title: "System Design",
      description: "Designed the initial architecture for the privacy-aware multi-agent system.",
      status: "completed",
    },
    {
      icon: Target,
